            ...
            <form action="<?= base_url('admin/buku_besar/akun/store') ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="kategori" name="kategori" required>
                        ...
                        <option value="Pasiva" <?= old('kategori') == 'Pasiva' ? 'selected' : '' ?>>Pasiva</option>
                        <option value="Modal" <?= old('kategori') == 'Modal' ? 'selected' : '' ?>>Modal</option>
                        <option value="Pendapatan" <?= old('kategori') == 'Pendapatan' ? 'selected' : '' ?>>Pendapatan
                        </option>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control" id="saldo_awal" name="saldo_awal"
                        value="<?= old('saldo_awal', '0.00') ?>" required>
                </div>
